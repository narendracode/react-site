...
<div className="container page-content">
    <div className="col-md-12">
  	...
  	<div className="col-md-12">
        ...
        <a href="https://github.com/narendrasoni1989" target="_blank" className="nav-link">
          Github
        </a>
        <a href="http://stackoverflow.com/users/2161130/narendrasoni" target="_blank" className="nav-link">
          Stackoverflow
        </a>
